...
const About = () => {
  return (
    <div className="min-h-screen text-wrap">
      <NavBar />
      <div className="py-16 w-full bg-linear-180 from-beta to-[#7a6651] "></div>
      <div className="px-4 md:px-20 py-16">
        <div className=" mt-16 py-16">
          <h1 className="md:text-4xl text-2xl lg:px-16 font-bold text-(--textHighlight)">
            About Comforte's Lodge
          </h1>
          <div className="flex flex-col-reverse lg:flex-row-! justify-center items-center gap-4">
            <h1 className="text-2xl max-w-4xl text-justify mt-8 text-beta">
            ...
            <video
              ...
              loop
              muted
              className="rounded-full m-8 bg-cover bg-center"
            />
          </div>
        </div>
      </div>
      ...
      <div className="py-16 flex px-4 md:px-20 flex-col items-center">
        ...
        <div className="flex gap-4">
          <h1 className="text-2xl max-w-4xl text-justify mt-8 text-beta">
            {" "}
            We stand on the historic Christian faith, revealed in Scripture and
            lived in the power of the Holy Spirit:
            <br /> - The Bible as God’s inspired, infallible, and authoritative
            Word
            <br /> - Salvation by grace through faith in Jesus Christ alone
            <br /> - The Trinity: one God eternally existing as Father, Son, and
            Holy Spirit
            <br /> - The present-day person, power, gifts, and ministry of the
            Holy Spirit
            <br /> - A life marked by holiness, worship, and loving service{" "}
            <br />
            <p className="font-bold tracking-wide text-2xl">
              <Link to="/declaration">Read our Declaration of Faith</Link>
            </p>
          </h1>
        </div>
      </div>
